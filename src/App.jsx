...
function SplashIntro({ onFinish, lang }) {
  ...
  const pins = [
    { x: 79.9, y: 48.3, n: 1 }, { x: 66.1, y: 66.6, n: 2 }, { x: 79.8, y: 95.6, n: 3 }, { x: 92.2, y: 138.9, n: 4 },
    { x: 90.8, y: 148.6, n: 5 }, { x: 82.0, y: 168.0, n: 6 }, { x: 71.6, y: 223.8, n: 7 }, { x: 56.5, y: 244.4, n: 8 },
  ];
  const routeD = "M" + pins.map((p) => `${p.x},${p.y}`).join(" L");
  const flightD = "M-5,60 Q90,-40 100,45";
  const landD = "M124.8,174.2 C122.1,172.8 115.2,168.0 110.1,166.7 C104.9,165.4 98.4,169.2 96.3,167.0 C94.2,164.7 100.7,156.5 98.6,154.2 C96.4,152.0 87.2,151.0 84.3,154.2 C81.5,157.5 84.8,164.7 83.0,172.2 C81.1,179.7 76.8,189.2 74.2,196.0 C71.7,202.9 69.7,205.6 69.0,210.4 C68.2,215.1 68.0,220.1 70.1,222.3 C72.2,224.5 77.6,219.9 80.7,222.7 C83.8,225.4 85.6,232.3 87.3,237.5 C89.0,242.8 87.9,247.5 90.1,251.7 C92.2,256.0 95.8,259.0 99.3,261.0 C102.7,263.0 105.8,261.1 109.2,263.0 C112.5,264.9 117.1,268.7 117.7,271.4 C118.2,274.2 115.0,276.6 112.1,278.1 C109.3,279.7 103.7,281.2 101.6,280.0 C99.4,278.8 102.8,274.5 100.2,271.7 C97.6,268.9 89.8,265.4 86.9,264.6 C84.0,263.8 85.8,268.0 84.1,267.4 C82.5,266.8 79.3,263.8 77.7,261.3 C76.0,258.7 77.0,256.2 74.9,253.1 C72.9,250.0 69.2,247.0 66.2,244.0 C63.2,240.9 60.3,235.9 58.4,236.2 C56.5,236.5 56.7,245.6 55.6,245.7 C54.5,245.8 52.7,240.2 52.4,236.7 C52.2,233.3 53.0,231.2 54.2,226.6 C55.4,221.9 56.8,216.7 59.1,210.9 C61.3,205.1 63.9,199.9 66.9,194.2 C69.9,188.4 75.3,184.4 75.8,179.0 C76.3,173.6 70.7,168.2 69.6,164.2 C68.6,160.1 70.2,159.5 69.9,156.5 C69.6,153.5 70.3,151.4 68.0,147.4 C65.7,143.4 59.7,138.2 57.0,134.4 C54.3,130.6 52.8,128.3 53.1,126.2 C53.4,124.2 56.7,126.4 58.8,123.3 C60.9,120.2 64.9,113.6 64.8,109.1 C64.7,104.6 61.2,102.5 58.2,98.4 C55.1,94.3 51.1,91.2 47.8,86.5 C44.5,81.7 40.2,75.3 40.0,72.1 C39.8,69.0 44.1,72.9 46.7,69.2 C49.2,65.5 50.8,54.8 54.2,51.5 C57.7,48.2 62.0,52.2 65.7,50.8 C69.5,49.5 71.8,45.7 75.2,43.8 C78.5,41.8 81.6,39.8 84.6,40.0 C87.6,40.2 90.2,42.4 91.7,45.1 C93.1,47.8 90.5,53.0 92.6,54.9 C94.8,56.7 102.4,52.3 103.6,55.5 C104.9,58.8 100.2,67.1 99.5,72.8 C98.8,78.5 96.8,86.5 100.0,87.4 C103.2,88.3 113.2,78.9 117.2,77.6 C121.2,76.4 119.5,80.0 122.0,80.4 C124.6,80.9 129.1,81.1 131.4,80.0 C133.8,79.0 132.1,75.2 134.9,74.4 C137.7,73.6 142.6,72.9 147.1,75.5 C151.5,78.1 157.0,83.5 159.5,88.8 C161.9,94.0 158.1,99.4 160.6,104.8 C163.2,110.3 171.5,114.0 173.7,119.0 C176.0,124.1 174.1,129.0 173.0,132.8 C172.0,136.6 171.5,139.3 167.7,140.2 C164.0,141.1 158.9,137.6 152.4,137.8 C145.8,137.9 137.1,138.0 131.4,141.0 C125.8,144.0 122.1,148.5 120.9,154.5 C119.7,160.5 124.1,170.7 124.8,174.2 Z";
  return (
    <div className={"mt-intro" + (exiting ? " exiting" : "")} onClick={skip}>
      <div className="mt-intro-inner">
        <svg viewBox="0 0 400 320" className="mt-intro-svg">
          ...
          <polygon points="0,-13 28,0 0,13 7,0" className="mt-intro-plane">
  ...
  return (
    <>
      ...
      <style>{`
        ...
        .mt-intro-route { fill:none; stroke:#D98E3F; stroke-width:2.6; stroke-linecap:round; stroke-linejoin:round; stroke-dasharray:600; stroke-dashoffset:600; animation:mt-route-draw 1.6s ease forwards; animation-delay:1.8s; filter:drop-shadow(0 1px 1px rgba(0,0,0,.15)); }
