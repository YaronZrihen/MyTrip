...
function SplashIntro({ onFinish, lang }) {
  ...
  const pins = [
    { x: 178, y: 92, n: 1 }, { x: 163, y: 122, n: 2 }, { x: 168, y: 152, n: 3 }, { x: 158, y: 180, n: 4 },
    { x: 150, y: 208, n: 5 }, { x: 146, y: 236, n: 6 }, { x: 152, y: 262, n: 7 }, { x: 160, y: 284, n: 8 },
  ];
  const routeD = "M" + pins.map((p) => `${p.x},${p.y}`).join(" L");
  const flightD = "M-5,85 Q160,-55 222,68";
  return (
    <div className={"mt-intro" + (exiting ? " exiting" : "")} onClick={skip}>
      <div className="mt-intro-inner">
        <svg viewBox="0 0 400 320" className="mt-intro-svg">
          ...
          <path className="mt-intro-land" filter="url(#mtShadow)" fill="url(#mtLandGrad)"
            d="M150,15 C175,10 200,15 212,32 C222,45 235,55 230,72 C225,88 210,90 205,105
               C200,120 195,135 192,155 C189,175 186,195 183,215 C180,235 178,255 176,270
               C174,282 170,292 163,297 C156,290 155,278 150,265 C146,250 144,232 142,212
               C140,192 138,172 136,152 C134,132 128,118 122,105 C112,95 100,90 95,75
               C90,60 92,45 100,32 C108,20 128,12 150,15 Z" />
